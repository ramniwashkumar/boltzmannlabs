...
export default function NavbarBoltbio() {
    ...
    return (
        <nav className={`w-full z-20 h-auto top-0 start-0  text-customBlue p-2 bg-white transition-colors duration-300`}>
            <div className="container mx-auto flex items-center justify-between h-full p-2">
                <img alt="Boltchem" src="/rebolt_icon.png" className='h-[50px]' />
                ...
                <div className="hidden md:flex space-x-3">
                    <button onClick={() => window.location.href = "https://x.com/LabsBoltzmann"} className="rounded-full">
                        <FontAwesomeIcon icon={faXTwitter} className="text-customBlue text-xl" />
                    </button>
                    <button onClick={() => window.location.href = "https://www.youtube.com/@boltzmannlabs8539"} className="rounded-full">
                        <FontAwesomeIcon icon={faYoutube} className="text-customBlue text-2xl" />
                    </button>
                    <button onClick={() => window.location.href = "https://www.linkedin.com/company/boltzmannlabs"} className="rounded-full">
                        <FontAwesomeIcon icon={faLinkedin} className="text-customBlue text-2xl" />
                    </button>
                    <button onClick={() => window.location.href = "https://www.facebook.com/boltzmann.labs/"} className="rounded-full">
                        <FontAwesomeIcon icon={faFacebook} className="text-customBlue text-2xl" />
                    </button>
                    <button onClick={() => window.location.href = "https://www.instagram.com/boltzmannlabs1"} className="rounded-full">
